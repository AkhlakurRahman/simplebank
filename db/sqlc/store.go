...
// executeTx execute a function within a database transaction
...
// TransferTxParams contains the input parameter of of transfer transaction
...
func (store *Store) TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
	...
	err := store.executeTx(ctx, func(q *Queries) error {
		...
		// Get the accounts - add and subtract the transferred account accordingly
